...
public class GearingUnitRecipe implements Recipe<Container> {
    private final ResourceLocation id;
    private final NonNullList<InputEntry> input;
    private final ItemStack output;

    public GearingUnitRecipe(ResourceLocation id, NonNullList<InputEntry> input, ItemStack output) {
        this.id = id;
        this.input = input;
        this.output = output;
    }
    ...
    public static class Serializer implements RecipeSerializer<GearingUnitRecipe> {
        ...
        @Override
        public GearingUnitRecipe fromJson(ResourceLocation id, JsonObject json) {
        ...
        @Override
        public GearingUnitRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, GearingUnitRecipe recipe) {
