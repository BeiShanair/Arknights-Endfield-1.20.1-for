...
public class PackagingUnitRecipe implements Recipe<Container> {
    private final ResourceLocation id;
    private final NonNullList<InputEntry> input;
    private final ItemStack output;

    public PackagingUnitRecipe(ResourceLocation id, NonNullList<InputEntry> input, ItemStack output) {
        this.id = id;
        this.input = input;
        this.output = output;
    }
    ...
    public static class Serializer implements RecipeSerializer<PackagingUnitRecipe> {
        ...
        @Override
        public PackagingUnitRecipe fromJson(ResourceLocation id, JsonObject json) {
        ...
        @Override
        public PackagingUnitRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, PackagingUnitRecipe recipe) {
